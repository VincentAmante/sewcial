...
<template>
  <div
    ...
    class="description-slider-wrapper absolute top-0 left-0 w-screen h-screen z-[105] overflow-hidden pointer-events-none transition-all ease-out duration-150"
  >
    <div
    ...
    >
      <div class="button-close absolute right-0 pt-mobile pr-mobile">
        <!-- DEV: ButtonClose has a function for when the 'close-btn-clicked' emit is triggered -->
        <ButtonClose @close-btn-clicked="close" />
      </div>
      <div class="slider-content flex flex-col h-full justify-center desktop:flex-row desktop:items-center desktop:justify-start desktop:grid desktop:grid-flow-col px-mobile">
